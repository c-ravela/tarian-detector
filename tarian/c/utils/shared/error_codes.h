...
enum map_codes_e {
  RINGBUF_CAPACITY_REACHED_ERR = 200UL, /* ring buffer is at full capacity; no
                                           space available for new entries  */
  BUFFER_DATA_SIZE_EXCEEDED_ERR, /* data buffer capacity exceeded allocated
                                    threshold */
  BUFFER_FULL_ERR,
  ZERO_SIZE_ERR,
  MAP_ERROR_MAX = 299UL
